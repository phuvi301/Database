...
Suất chiếu được tạo ra và kiểm duyệt dựa trên các thông tin mà quản lý rạp cung cấp bao gồm lịch dự kiến (Schedule Date), thời lượng dự kiến (Duration Adjust), hình thức suất chiếu (Format) và giá vé cơ bản (BasePrice).
